...
public class LitematicRenderer {
    ...
    private void renderMesh(MatrixStack matrices, int x, int y, int size) {
        ...
        RenderSystem.backupProjectionMatrix();Matrix4f projectionMatrix = Matrix4f.projectionMatrix(-aspectRatio, aspectRatio, 1, -1, -1000, 3000);
        ...
        matrices.multiply(Vec3f.POSITIVE_X.getDegreesQuaternion(slant));
        ...
        //#else
        //$$ drawModel(matrices.peek().getModel());
        //#endif
