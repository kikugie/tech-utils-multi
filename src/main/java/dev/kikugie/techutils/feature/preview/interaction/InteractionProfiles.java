...
public enum InteractionProfiles implements IConfigOptionListEntry {
    ...
    public final Text name = Text.translatable(TRANSLATION_KEY_BASE + value);
    public final Text description = Text.translatable(TRANSLATION_KEY_BASE + value + ".description");
